	...
	<aside id="sidebar">
		...
		<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar($sidebar_name)) : else : ?>
			...
			<section class="widget">
				<?php /*?><h3 class="widget-title"><span><?php _e('No Widgets Added Yet', 'jwlocalize'); ?></span></h3>
				<p><?php _e('Please add them in the WordPress admin page under Appearance &rarr; Widgets. The widget section is called', 'jwlocalize'); ?> <strong><?php echo $sidebar_name; ?></strong></p> <?php */?>
			</section>
