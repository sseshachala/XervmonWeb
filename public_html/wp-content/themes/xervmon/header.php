...
<head>
	...
	<link  href="<?php get_template_directory_uri()?>/css/jquery.fancybox.css?v=2.1.5"  type="text/css" rel="stylesheet" />
    
	<script type="text/javascript" src="<?php get_template_directory_uri()?>/js/jquery-1.10.1.min.js"></script>

	<!-- Add mousewheel plugin (this is optional) -->
	<script type="text/javascript" src="<?php get_template_directory_uri()?>/js/jquery.mousewheel-3.0.6.pack.js"></script>

	<!-- Add fancyBox main JS and CSS files -->
	<script type="text/javascript" src="<?php get_template_directory_uri()?>/js/jquery.fancybox.js?v=2.1.5"></script>
			...
			<div id="header-inner">
				...
				<div id="header-main">
					...
					<div id="header-main-inner" class="wrapper clearfix" style="margin-bottom:15px;">
                        ...
                        <div style="text-align:center;"><!-- id="header-top-right" class="one-half last align-right"-->
							<div class="header_login"><a  class="fancybox"  href="<?php echo site_url() ?>/?page_id=1397" style="color:#2798D2;">Signup </a> |  <a href="https://apps.xervmon.com/" style="color:#2798D2;">Login</a></div><br>
								<?php
									if($jw_option[$sn.'_header_right'] == 'content'){
										echo $jw_option[$sn.'_header_right_text'];
									}elseif($jw_option[$sn.'_header_right'] == 'social_search'){
...
<div class="blue_sky"><img src="<?php echo get_template_directory_uri(); ?>/images/quote.png" style="margin: -14px 0 0;"/>Simply you control your cloud under clear, blue sky<img src="<?php echo get_template_directory_uri(); ?>/images/quote2.png" style="margin: -10px 0 0;"/></div>
</div>
<?php } ?>
				</div><?php */?><!-- #main-slider -->
