						...
						$(".css3_grid_slider").each(function(){
							...
							$(window).resize(function(){
								if($("#"+id).hasClass("p_table_sliding"))
									css3GridSetWidth(id);
								$(".css3_grid_slider").trigger("updateSizesCustom");
							});
						});
